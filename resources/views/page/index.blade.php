            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="recipe-item">
                        <a href="/detail"><img src="img/banner-22.jpg" alt=""></a>
                        <div class="ri-text">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="recipe-item">
                        <a href="#"><img src="img/banner-22.jpg" alt=""></a>
                        <div class="ri-text">
                            <div class="cat-name">Desert</div>
                            <a href="#">
    ...
    <section class="categories-feature-recipe spad">
        ...
        <div class="container po-relative">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="cfr-item">
                        <div class="cfr-item-img set-bg" data-setbg="img/banner-22.jpg">
                            <i class="fa fa-plus"></i>
                        </div>
