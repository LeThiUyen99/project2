...
foreach($this->arrayLabel as $key=>$lable){
   ...
   function showRenew($record_id){
		return '<td width="10" align="center"><a class="renew"  rel="tooltip" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Bạn muốn làm mới ứng viên?")) . '\')){ renewone(' . $record_id . '); }" title="' . translate_text("Bạn muốn làm mới bản ghi") . '" href="#"><img src="' . $this->image_path . 'reset.png" border="0"></a></td>';
	}
   function showRenewTin($record_id){
		return '<td width="10" align="center"><a class="renew"  rel="tooltip" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Bạn muốn làm mới tin tuyển dụng?")) . '\')){ renewone(' . $record_id . '); }" title="' . translate_text("Bạn muốn làm mới bản ghi") . '" href="#"><img src="' . $this->image_path . 'reset.png" border="0"></a></td>';
	}
