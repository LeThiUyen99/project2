...
$myform->add("cate_des","cate_des",0,0,"",0,translate_text("Vui lòng nhập mô tả cho danh mục"),0,"");
...
$query = "SELECT cate_des FROM " . $fs_table . " WHERE " . $field_id . " = " . $record_id;
...
<?=$form->close_table();?>
<?=$form->wysiwyg("Mô tả danh mục", "cate_des", $cate_des, "../../resource/ckeditor/", "50%","600")?>
<?=$form->create_table();?>
