...
$db_select = new db_query("SELECT CategoryID FROM " . $fs_table . " WHERE CategoryID =" . $record_id);
...
if($row=mysql_fetch_assoc($db_select->result)){
    ...
    $db_del = new db_execute("DELETE FROM ". $fs_table ." WHERE CategoryID =" . $record_id);
