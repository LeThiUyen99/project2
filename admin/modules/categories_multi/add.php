...
#+ Array category	
$menu 				= new menu();
$listAll 			= $menu->getAllChild("categories_multi","cat_id","cat_parent_id","0",$sql." AND lang_id = " . $lang_id . $sqlcategory,"cat_id,cat_name,cat_order,cat_type,cat_parent_id,cat_has_child","cat_type, cat_order ASC, cat_name ASC","cat_has_child");
...
<?=$form->text(translate_text("Đường dẫn"),"cat_link","cat_link",$cat_link,translate_text("Đường dẫn"),0,300,"",255)?>
<? 
...
if($array_config["description"]==1) echo $form->textarea(translate_text("Mô tả"), "cat_description", "cat_description", $cat_description, translate_text("description"), 1, 600, 120, "", "", "");
