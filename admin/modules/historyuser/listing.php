...
<script src="/js/admin/js/admin-quan-ly-lich-su-giao-dich-nguoi-dung.js?v=1"></script>
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
 ...
 <script>
        $(document).ready(function () {
            var lichSuGiaoDichNguoiDung = new LichSuGiaoDichNguoiDung();
            lichSuGiaoDichNguoiDung.initLichSuGiaoDichNguoiDung();
        });
    </script>
<div class="">  
    <br />
   <div class="row tieuDeAdmin">
        <div class="col-sm-12">
            <h3>Hệ thống xem lịch sử khách hàng</h3>
        </div>
    </div>
    <!--Chức năng-->
     <div class="row" style="margin-bottom:5px; margin-top:5px; margin-left:-15px; margin-right:-15px; padding-top:5px; padding-bottom:5px">
        <div class="col-lg-1" style="float: left; padding-bottom: 5px;">
        ...
        <div class="col-sm-3" style="text-align:right; padding-top:2px;">
            <div class="input-group" style="width: 100%; text-align: right">
                <input type="text" id="txtfinKey" placeholder="Vui lòng nhập email khách hàng cần tìm cần tìm ....." class="ctrlsearch form-control" />
    ...
    <div class="row">
        <div class="col-sm-12">
            <table id="tblLichSuGiaoDichNguoiDung" class="display table table-bordered table-responsive dt-responsive datatable" cellspacing="0" style="width:100%">
                <thead>
                    <tr>
                        <th>Giao dịch</th>
                        <th>Amount</th>
