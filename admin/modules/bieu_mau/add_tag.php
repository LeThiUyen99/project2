...
$myform->add("bmt_name","bmt_name",0, 0,"",1,"Bạn chưa nhập tên tag",0,"");
// $myform->add("","cit_parent",0, 0,"",1,"Bạn chưa chọn tên tỉnh thành",0,"");
...
<?=$form->text("Nhập tag biểu mẫu","bmt_name","bmt_name",$bmt_name,"tên tag",1,500,"",255)?>
