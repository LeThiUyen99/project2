...
<script src="/js/AdminP300.js"></script>
...
<div class="row" style="border:1px solid #CCCCCC; font-weight:bold; margin-left:0px; margin-right:0px; padding-top:7px; padding-bottom:7px; padding-left:7px">
    ...
    <div class="pull-right col-md-6" style="text-align:right;">Tổng thành tiền: <input style="padding:3px; color:red" type="text" id="moneyinaccount" /> VNĐ</div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <table id="tblP300" class="display table table-bordered table-responsive table-striped dt-responsive datatable" cellspacing="0" style="width:100%">
            <thead>
                <tr>
                    <th>Họ và tên</th>
                    <th>Tên tài khoản</th>
