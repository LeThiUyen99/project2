...
if (isset($_GET['city']) && isset($_GET['type']) && isset($_GET['qh']) && isset($_GET['cate']) && isset($_GET['cb']) && isset($_GET['name']))
{
    $city = $_GET['city'];
    $type = $_GET['type'];
    $qh = $_GET['qh'];
    ...
    if ($type == 'false') { $type = '0'; }else{ $type = '1';}
     ...
     $db_check = new db_query("SELECT count(1) FROM keyword WHERE key_cate_id = '$cate' AND key_type = '$type' AND key_city_id = '$city' AND key_qh_id = '$qh' AND key_cb_id = '$cb' AND key_name = '$name'");
...
if($action == "submitForm"){
  ...
  $errorMsg .= $myform->checkdata();
	...
	if($errorMsg == ""){
        ...
        $check_sql = "SELECT count(1) FROM keyword WHERE key_name = '".$_POST['key_name']."' AND key_cate_id = '".$_POST['key_cate_id']."' AND key_city_id = '".$_POST['key_city_id']."' AND key_qh_id = '".$_POST['key_qh_id']."' AND key_cb_id = '".$_POST['key_cb_id']."' AND key_type = '".$type."'";
...
<script type="text/javascript">  
    $(document).ready(function(){
        ...
        $("input").keyup(function(){
            ...
            $.get("add.php?city="+city+"&type="+type+"&qh="+qh+"&cate="+cate+"&cb="+cb+"&name="+name, function(data){
