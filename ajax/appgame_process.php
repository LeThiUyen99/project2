<div class="list_show_more">
    ...
    $db_loadmore = new db_query("SELECT Id,articles.categoryid,PublicDate,articles.Intro,articles.MetaDesc,ImageUrl,Title,categoryname,ShortTitle,view,category_parent_id
                                FROM articles 
