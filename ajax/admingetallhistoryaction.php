...
if(isset($_POST) && $_SERVER['REQUEST_METHOD'] =='POST')
{
    ...
    if(strpos($headers['Referer'],'/admin/modules'))
    {
        ...
        $kq = AdminGetAllHistoryAction($findkey,$tuNgay ,$denNgay,$status,$iDisplayStart,$iDisplayLength);//AdminVnpayTopupMobile($tuNgay ,$denNgay,$findkey,$iDisplayStart,$iDisplayLength);
