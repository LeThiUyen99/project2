...
if(isset($_POST) && $_SERVER['REQUEST_METHOD'] =='POST')
{
    ...
    if(strpos($headers['Referer'],'/admin/modules'))
    {
        ...
        $nguoiChuyen = getValue("nguoiChuyen","str","POST","");
        $nguoiChuyen = replaceMQ($nguoiChuyen);
        $nguoiChuyen = removeHTML($nguoiChuyen);
        ...
        if($tuNgay==""){
            ...
            $tuNgay=date("Y-m-d H:i:s",strtotime($tuNgay.':00'));
        }
        if($denNgay==""){
            $date=date("Y-m-d",time());
            ...
            $denNgay=date("Y-m-d H:i:s",strtotime($denNgay.':59'));
        }
        
        $total=0;
        //var_dump($fromDate,$toDate,$taiKhoan,$nhom);die();
        $kq = AdminGetAllCashOutLog($findKey,$tuNgay,$denNgay,$trangThai,$nganHang,$nguoiChuyen,$sotien,$iDisplayStart,$iDisplayLength);
        $kq1= AdminGetTotalAllCashOutLog($findKey,$tuNgay,$denNgay,$trangThai,$nganHang,$nguoiChuyen,$sotien);
        ...
        "tongTienDaChuyen"=>$kq1['tongTienDaChuyen'],
        "tongTienChuaChuyen"=>$kq1['tongTienChuaChuyen'],
        "tongLenh"=>$kq1['tongLenh'],
        "lenhDaChuyen"=>$kq1['lenhDaChuyen'],
        "lenhChuaChuyen"=>$kq1['lenhChuaChuyen'] ];
