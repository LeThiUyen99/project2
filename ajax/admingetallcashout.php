...
if(isset($_POST) && $_SERVER['REQUEST_METHOD'] =='POST')
{
    ...
    if(strpos($headers['Referer'],'/admin/modules'))
    {
        ...
        $kq = AdminGetAllCashOut($findKey,$tuNgay,$denNgay,$trangThai,$iDisplayStart,$iDisplayLength);
        $kq1= AdminGetTotalAllCashOut($findKey,$tuNgay,$denNgay,$trangThai);
        ...
        "data" => $kq['kq'],
        "tongdaduyet"=>$kq1['tongduyet'],
        "tongTaiKhoan"=>$kq1['tongtien'] ];
