    ...
    <div class="row">
      ...
      <div class="col-md-12 noidung_naptien">
        ...
        <div class="thongtin_naptien">
          <p>Để nạp tiền mua thẻ cào. Quý khách hàng của banthe247.com vui lòng chuyển khoản vào một trong các tài khoản ngân hàng dưới đây của chúng tôi.</p>
        ...
        <div class="ly_naptien">
          ...
          <p style="color: #0098DB;"> [Tài khoản email] - Mua the cao dien thoai tai web Banthe247.com</p>
        </div>

        <p class="tt_naptien">CÁC TÀI KHOẢN NGÂN HÀNG CỦA BANTHE247.COM</p>

        <div class="tk_naptien">
          <p style="font-weight: 700;color: #444444;">Tài khoản công ty</p>
          <div class="ds_bank">
            <a class="active nh1"><img src="/images/nh3.png" alt="ngân hàng MSB"></a>

            <div class="nd_tkbank nh1_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Liên hệ hotline</p>              
            </div>

          </div>

          <p style="font-weight: 700;color: #444444;margin-top: 20px;">Tài khoản cá nhân</p>
          <div class="ds_bank">
          ...
          <div>
            <div class="nd_tkbank nh2_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng MSB </p>
            ...
            <div class="nd_tkbank nh3_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng BIDV </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh4_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng Vietinbank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh5_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng Agribank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh6_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng Techcombank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh7_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng MBbank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh8_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng TPbank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh9_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng ACB </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
            ...
            <div class="nd_tkbank nh10_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Số tài khoản:</strong> Ngân hàng Vietcombank </p>
              <p><strong>Chủ tài khoản:</strong> Dương Thị Minh Tuyển </p>
        ...
        <div class="col-md-3 tbnt nt2">
          <a href="">Thông báo trên Chatbox</a>
        </div>

        <div class="col-md-3 tbnt nt3">
          <a href="">Thông báo qua Skype</a>
        </div>

        <div class="col-md-3 tbnt nt4">
          <a href="">Thông báo qua Hotline</a>
        </div>                
