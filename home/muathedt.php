...
<html>
  <head>
    ...
    <title>Mua thẻ điện thoại, mua thẻ cào Viettel, Mobi, Vina online giá rẻ</title>
    <meta name="description" content='Đăng ký miễn phí tài khoản mua thẻ điện thoại online giá rẻ, mua card đt mọi lúc, mọi nơi. Mua thẻ cào Viettel, Vina, Mobi,... trực tuyến UY TÍN, chiết khấu cao.' />
    ...
    <link rel="canonical" href='https://banthe24h.vn/tien-ich/mua-the-dien-thoai' />
  ...
  <body style="cursor: pointer !important;">
    ...
    <div class="container">
      <div class="row">
        <div class="divcontent1 divmuathe">
          <h1 class="section-title bg-lable1" style="font-size: 22px;text-transform: uppercase;height: auto !important;"><span>Mua thẻ điện thoại online, mua thẻ cào Viettel, Mobi, Vina giá rẻ</span></h1>
          <div class="form-content bg1 col-md-4"  style="border : none">
              ...
              <div class="form-group">
                <div class="boxdrpmega">
                  <table rel="" style="margin-top:0px!important;" width="100%">
                    <tr >
                      <td id="trproviderdt">
                        <select id="ProviderIdDT" class="form-control"><option value="">Chọn nhà cung cấp</option><option value="1">Viettel</option><option value="2">Mobifone</option><option value="3">Vinaphone</option><option value="7">Vietnammobile</option></select>
                      </td>
                    </tr>
                  </table>
                </div>
            ...
            <div class="col-md-8 bg1 form-content" style="border:none">
              <div id="thongtingiaodich">
                ...
                <div>
                  <label class="control-label bold">* Sử dụng tài khoản thành viên để nhận được chiết khấu cao nhất <pre style="color:#ff0000;">Viettel: 2.5%, Vina và Mobi là 3.5%</pre></label>
                  <label class="control-label bold">* Bán thẻ cho GAME: <pre style="color:#ff0000;"><a rel="nofollow" style="color:#ff0000" href="http://banthe24h.vn/API_mua_ma_the.pdf">Tài liệu hướng dẫn tích hợp API mua thẻ tự động</a></pre></label>
    ...
    <div class="modal fade" id="thedtshowresultmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h4 class="modal-title" id="myModalLabel1"><i class="fa fa-caret-square-o-right"></i>Thông báo giao dịch mua mã thẻ</h4>
          </div>
          <form class="form-horizontal" role="form">
            <div class="panel-body">
              <div class="">
