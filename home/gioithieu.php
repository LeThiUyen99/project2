...
<head>
   ...
   <title>Banthe247 - Giới thiệu</title>
   <meta name="description" content='Giới thiệu website Banthe247.com và các dịch vụ tiện ích, bạn có thể mua thẻ cào, nạp tiền điện thoại, mua thẻ data nhanh chóng, chiết khấu cao tại Banthe247.com' />
   ...
   <link rel="canonical" href='https://banthe247.com/gioi-thieu' />
...
<body style="cursor: pointer !important;">
  ...
  <div class="container">
    ...
    <h3 class="page_titel">Giới thiệu</h3>
    <?
$db_qr = new db_query("SELECT * FROM `newstable` WHERE Type = '5' AND IsActive='1'");
