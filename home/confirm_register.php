...
<head>
   ...
   <title>Xác nhận đăng ký tài khoản tại banthe247.com</title>
   <meta name="description" content='Xác nhận đăng ký tài khoản tại banthe247.com' />
   <meta name="keywords" content='Xác nhận đăng ký tài khoản tại banthe247.com' />
   ...
   <div class="divcontent1"></div>
      ...
      <div class="col-md-8 col-xs-12 main-tintuc-left">
        <div class="" style="padding:10px;">
                     <h1 class="page_titel">Xác nhận đăng kí tài khoản</h1>
                     <div>Bạn vui lòng đăng nhập tài khoản email, và xác nhận tại link gửi trong mail đính kèm</div>
                  </div>
      </div>
