...
<head>
   ...
   <title>Thông báo nạp tiền vào tài khoản trên banthe24h.vn</title>
   <meta name="description" content='Thông báo nạp tiền vào tài khoản trên banthe24h.vn' />
   <meta name="keywords" content='Thông báo nạp tiền vào tài khoản trên banthe24h.vn' />
   ...
   <link rel="canonical" href='https://banthe24h.vn/thong-bao-mua-tcoin' />
...
<body style="cursor: pointer !important;">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12 noidung_naptien">
<!--         <p class="tt_naptien">Thông tin chi tiết dịch vụ</p>
        <div class="thongtin_naptien">
          <p>Để nạp tiền mua thẻ cào. Quý khách hàng của Banthe24h.vn vui lòng chuyển khoản vào một trong các tài khoản ngân hàng dưới đây của chúng tôi.</p>
        ...
        <div class="ly_naptien">
          <p style="font-weight: 500;color: #FF0000;">Cú pháp chuyển tiền:</p>
          <p style="color: #0098DB;"> [Tài khoản email] - Mua the cao tai Banthe24h.vn</p>
        </div>

        <p class="tt_naptien">Quý khách chọn 1 trong các tài khoản sau để chuyển tiền, tiền sẽ được cộng về tài khoản của quý khách ngay sau 3s</p>

        <div class="tk_naptien">

          <p style="font-weight: 700;color: #444444;margin-top: 10px;">Tài khoản cá nhân</p>
          <div class="ds_bank">
          ...
          <div>
            <div class="nd_tkbank nh2_active">
              ...
              <p><strong>Chi tiết:</strong> Nam Hà Nội </p>
              <p><strong>Nội dung chuyển tiền:</strong> [Tài khoản email] - Mua the cao tai web Banthe24h.vn </p>
              <p style="font-size: 15px;font-style: italic;color: #0098DB">Ngay sau 3s quý khách sẽ được cộng tiền vào tài khoản trên Banthe24h.vn để giao dịch</p>              
            </div>
            ...
            <div class="nd_tkbank nh3_active">
              ...
              <p><strong>Chi tiết:</strong> Hà Nội </p>
              <p><strong>Nội dung chuyển tiền:</strong> [Tài khoản email] - Mua the cao tai web Banthe24h.vn </p>
              <p style="font-size: 15px;font-style: italic;color: #0098DB">Ngay sau 3s quý khách sẽ được cộng tiền vào tài khoản trên Banthe24h.vn để giao dịch</p>                 
            </div>
            ...
            <div class="nd_tkbank nh4_active">
              ...
              <p><strong>Chi tiết:</strong> Thanh Xuân - Hà Nội </p>
              <p><strong>Nội dung chuyển tiền:</strong> [Tài khoản email] - Mua the cao tai web Banthe24h.vn </p>
              <p style="font-size: 15px;font-style: italic;color: #0098DB">Ngay sau 3s quý khách sẽ được cộng tiền vào tài khoản trên Banthe24h.vn để giao dịch</p>                 
            </div>
            ...
            <div class="nd_tkbank nh5_active">
              ...
              <p><strong>Chi tiết:</strong> Thăng Long, Hà Nội </p>
              <p><strong>Nội dung chuyển tiền:</strong> [Tài khoản email] - Mua the cao tai web Banthe24h.vn </p>
              <p style="font-size: 15px;font-style: italic;color: #0098DB">Ngay sau 3s quý khách sẽ được cộng tiền vào tài khoản trên Banthe24h.vn để giao dịch</p>                 
            </div>
            ...
            <div class="nd_tkbank nh10_active">
              ...
              <p><strong>Chi tiết:</strong> Hoàn Kiếm, Hà Nội </p>
              <p><strong>Nội dung chuyển tiền:</strong> [Tài khoản email] - Mua the cao tai web Banthe24h.vn </p>
              <p style="font-size: 15px;font-style: italic;color: #0098DB">Ngay sau 3s quý khách sẽ được cộng tiền vào tài khoản trên Banthe24h.vn để giao dịch</p>                 
            </div>
          ...
          <div class="ds_bank">
            ...
            <div class="nd_tkbank nh1_active">
              <p style="color: #0098DB;font-weight: 700;">Nội dung tài khoản:</p>
              <p><strong>Liên hệ:</strong> 1900633682 ấn phím 2 hoặc Chatbox <span onclick="javascript:void(Tawk_API.toggle())" style="position: unset;"><img src="/images/nt1.png" width="30" ></span></p>              
            </div>
          </div>
      ...
      <div class="col-md-3 col-sm-12 table_chietkhau">
        <p class="tt_naptien">Thông tin chiết khấu</p>

        <table border="1" cellpadding="1" cellspacing="1" style="width: 100%">
          <thead>
            <tr><th>Thẻ cào nhà mạng</th><th style="width: 40%">Chiết khấu</th></tr>
          </thead>
          <tbody>
            <tr><td>Viettel</td><td>2.5%</td></tr>
            <tr><td>Mobifone</td><td>3.5%</td></tr>
            <tr><td>Vinaphone</td><td>3.5%</td></tr>
            <tr><td>Vietnamobile</td><td>5%</td></tr>
          </tbody>
        </table>

        <table border="1" cellpadding="1" cellspacing="1" style="width: 100%">
          <thead>
            <tr><th>Thẻ game</th><th style="width: 40%">Chiết khấu</th></tr>
          </thead>
          <tbody>
            <tr><td>Gate (FPT)</td><td>3.5%</td></tr>
            <tr><td>Zing</td><td>3.5%</td></tr>
            <tr><td>Garena</td><td>3.5%</td></tr>
            <tr><td>VTC</td><td>3.5%</td></tr>
          </tbody>
        </table>

        <table border="1" cellpadding="1" cellspacing="1" style="width: 100%">
          <thead>
            <tr><th>Dịch vụ khác</th><th style="width: 40%">Chiết khấu</th></tr>
          </thead>
          <tbody>
            <tr><td>Thẻ DATA Mobi</td><td>7.5%</td></tr>
            <tr><td>Key Bitdefender</td><td>14%</td></tr>
            <tr><td>Key Kaspersky</td><td>14%</td></tr>
          </tbody>
        </table>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-12">
                      <select id="ddlTransferType" class="form-control" tabindex=2>
                          ...
                          <option value="4">Nộp tiền mặt tại Banthe24h.vn</option>
      ...
      <div class="modal_thtc">
        <div class="modal_content">
          <button type="button" class="close_button">X</button>
          <p class="thtc">THÔNG BÁO NẠP TIỀN CỦA QUÝ KHÁCH ĐÃ DƯỢC GỬI THÀNH CÔNG! CÁM ƠN QUÝ KHÁCH ĐẢ TIN TƯỞNG VÀ SỬ DỤNG DỊCH VỤ CỦA Banthe24h.vn</p>
          ...
          <script>
            ...
            $('.ds_bank a').click( function(){
              ...
              var position = $('.'+ a +'_active').offset().top - 120;
              $("body, html").animate({
                scrollTop: position
              }, 700 );
