...
<head>
   ...
   <title>Hướng dẫn mua Tcoin bằng mã thẻ tại banthe247</title>
   <meta name="description" content='Hướng dẫn mua Tcoin bằng mã thẻ, bạn cần đăng kí thành viên và đăng nhập tài khoản' />
   ...
   <link rel="canonical" href='https://banthe247.com/huong-dan' />
...
<body style="cursor: pointer !important;">
  ...
  <div class="container">
    ...
    <div class="article"> 
     ...
     <?
$db_qr = new db_query("SELECT * FROM `newstable` WHERE Type = '400' AND IsActive='1'");
