...
var QuanLyTinTuc = function () {
    ...
    self.TinTucFunction = function () {
        ...
        $("#btnCapNhatTin").click(function () {
            if (self.ValidateData() == true) {
                ...
                $.ajax({
                    url: Config.AppUrl + 'QuanLyTinNews/CapNhatTinTuc',
                    async: false,
                    type: "post",
                    data: {
                        Id: $("#txtIdTin").text(), Title: $("#txtTieuDe").val(), Description: b, SortOder: $("#txtShortOrder").val(), IsActive: status,
                        ImageUrl: $("#txtImage").val(), Type: $("#txtLoai").val()
                    },
    ...
    self.TinTucTable = function () {
        ...
        var dTable = $('#tblTinTuc').DataTable({
            ...
            "sAjaxSource": Config.AppUrl + 'QuanLyTinNews/DanhSachTinTuc',
            "lengthMenu": [20, 50, 100, 200, 1000],
            "aoColumns": [
            { "mData": "Id", "class": "dt-center" },
            { "mData": "Title" },
            { "mData": "IsActive", "class": "dt-center" },
            { "mData": "StrCreateDate" },
            {
                mData: "Id",
        ...
        $('#tblTinTuc').on('click', 'a._suaTinTuc', function (e) {
            ...
            self.RemoveToolTip();
            $.ajax({
                url: Config.AppUrl + 'QuanLyTinNews/ChiTietTin',
                async: false,
                data: { id: idTin },
                dataType: 'json',
                type: "post",
        ...
        $('#tblTinTuc').on('click', 'a._xoaTinTuc', function (e) {
            ...
            bootbox.confirm("Bạn có chắc chắn muốn xóa tin vừa chọn?", function (result) {
                $.ajax({
                    url: Config.AppUrl + 'QuanLyTinNews/XoaTinTuc',
                    async: false,
                    data: { id: id_Tin },
                    dataType: 'json',
                    type: "post",
