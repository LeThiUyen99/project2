...
var ThongKeSanLuong = function () {
    ...
    self.ThongKeSanLuongFunction = function () {
        ...
        $("#btnTimKiem").click(function () {
            self.RefreshTableUser("#tblThongKeSanLuongTheGachKhachLe");
        });
    }
    ...
    self.ThongKeSanLuongTable = function () {
        ...
        var dTable = $('#tblThongKeSanLuongTheGachKhachLe').DataTable({
            "bDestroy": true,
            "fnServerParams": function (aoData) {
                aoData.push(
                      ...
                      },
                      {
                       ...
                       {
                           "name": "hinhThuc",
                           "value": $("#optHinhThuc option").filter(":selected").val()
                       }
                )
            },
            //"bFilter": false,
            ...
            "sAjaxSource": '/administrator/ThongKeTheGachKhachLe/ThongKe',
            "lengthMenu": [20, 50, 100, 200, 500],
            "aoColumns": [
            { "mData": "TelcoCode", "class": "dt-center" },
