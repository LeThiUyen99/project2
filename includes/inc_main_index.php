...
<div class="container mid_content">
 <div class="divcontent1">
    <img class="banner_fix" style="position: fixed;left:5px;top: 120px;" src="/images/banner-fixed.jpg" alt="banner thẻ cảo giấy">
    <img class="banner_fix" style="position: fixed;right:5px;top: 120px;" src="/images/banner-fixed.jpg" alt="banner thẻ cảo giấy">
  <div id="maintopcontent">
    <div class="row">
      <div class="col-md-12">
        ...
        <?  
            $db_km = new db_query("SELECT * FROM `khuyen_mai_the`");
            While($row_km = mysql_fetch_assoc($db_km->result)){  
        ?>
          <p><span><?=$row_km['khuyen_mai']; ?></span> <span><?=$row_km['thoi_gian']; ?></span></p>
        <? } ?>
                     ...
                     <div class="row" id="Confirm_BuyCardDetail">
                      <div class="form-group col-sm-12">
                          <label class="col-sm-offset-1 col-sm-11" style="margin-top: 12px;">
                            <div style="font-weight: bold;color:#337ab7">Vui lòng nhập thông tin tài khoản của bạn <br/> Nếu chưa có tài khoản quý khách vui lòng đăng ký tại banthe24h.vn</div>
                          </label>
                      </div>
                        <div class="col-sm-12">
                      ...
                      <div class="form-group col-sm-12">
                       ...
                       <div class="col-sm-7">
                         <input readonly  
     onfocus="this.removeAttribute('readonly');" type="email" id="ctrlemailmuathetxt_log" name="ctrlemailtxt_log" class="form-control" placeholder="Địa chỉ Email" value=""  > </div>
                       </div>
                       <div class="form-group col-sm-12">
                         <label class="control-label col-sm-4" for="ctrlpasstxt_log">Mật khẩu:<span class="asterisk_input"></span></label>
                         <div class="col-sm-7">
                           <input readonly  
     onfocus="this.removeAttribute('readonly');" type="password" id="ctrlpassmuathetxt_log" name="ctrlpasstxt_log" class="form-control" placeholder="Mật khẩu" value="" > </div>
                         </div>
                         <div class="form-group col-sm-12">
                         ...
                         <form class="form-horizontal" role="form">
                          ...
                          <div class="row" id="Topup_Confirm_OrderDetail">
                            ...
                            <div class="form-group col-sm-12">
                             ...
                             <div class="col-sm-7">
                               <input readonly  
     onfocus="this.removeAttribute('readonly');" type="email" id="ctrlemailtopuptxt_log" name="ctrlemailtopuptxt_log" class="form-control" placeholder="Địa chỉ Email" value="" > </div>
                             </div>
                             <div class="form-group col-sm-12">
                               <label class="control-label col-sm-4" for="ctrlpasstxt_log">Mật khẩu:<span class="asterisk_input"></span></label>
                               <div class="col-sm-7">
                                 <input readonly  
     onfocus="this.removeAttribute('readonly');" type="password" id="ctrlpasstopuptxt_log" name="ctrlpasstopuptxt_log" class="form-control" placeholder="Mật khẩu" value=""> </div>
                               </div>
                               <div class="form-group col-sm-12">
                           ...
                           <div class="panel panel-primary">
                             ...
                             <div class="row" id="Confirm_OrderGameDetail">
                              ...
                              <div class="form-group col-sm-12">
                               ...
                               <div class="col-sm-7">
                                 <input readonly  
     onfocus="this.removeAttribute('readonly');" type="email" id="ctrlgameemailtxt_log" name="ctrlgameemailtxt_log" class="form-control" placeholder="Địa chỉ Email" value="" > </div>
                               </div>
                               <div class="form-group col-sm-12">
                                 <label class="control-label col-sm-4" for="ctrlpasstxt_log">Mật khẩu:<span class="asterisk_input"></span></label>
                                 <div class="col-sm-7">
                                   <input readonly  
     onfocus="this.removeAttribute('readonly');" type="password" id="ctrlgamepasstxt_log" name="ctrlgamepasstxt_log" class="form-control" placeholder="Mật khẩu" value=""> </div>
                                 </div>
                                 <div class="form-group col-sm-12">
                                   <div class="col-sm-offset-4 col-sm-7"> <a class="pull-right" href="#" data-dismiss="modal" data-toggle="modal" data-target="#forgotyourpassword"><i>Quên mật khẩu</i></a> <span class="pull-right">&nbsp;&nbsp;|&nbsp;&nbsp;</span> <a class="pull-right" href="/User/register"><i>Đăng ký</i></a> </div>
                                 </div>
                             ...
                             <div class="panel-body">
                               <div class="">
                                 ...
                                 <div class="divgameresult">
                                   ...
                                   <span id="xuatexelgame" class="btn btn-green">Chi tiết mã thẻ</span> </div>
                                 </div>
                                 <div class="modalbottom">
...
<div class="iframe_box container">
<iframe align="middle" frameborder="0" id="yoube" scrolling="no" src="https://www.youtube.com/embed/UssNzo6m1p8" width="100%"></iframe>
</div>
<style type="text/css">
.iframe_box iframe{height:530px;margin-top:20px}@media screen and (max-width:1000px){.iframe_box iframe{height:230px}}.khuyenmai_box{background:url(/images/chiet_khau2.png) center center #fff no-repeat;position:absolute;top:20px;right:20px;width:440px;padding:6px;height:220px;border-radius:10px;border:solid 3px #00b4bf;box-sizing:unset}.khuyenmai_box p:first-child{margin-top:60px}.khuyenmai_box p{font-size:14px;line-height:50px;text-align:right;margin-bottom:0}.khuyenmai_box p span:first-child{font-weight:700}.khuyenmai_box p span{width:96px;display:inline-block;text-align:center;vertical-align:middle;line-height:16px}
