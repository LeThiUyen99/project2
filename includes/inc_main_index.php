...
<div class="container mid_content">
 <div class="divcontent1">
    ...
    <img src="/images/banner-fixed.jpg" style="position: fixed;top: 120;right: 0px;" alt="Thẻ cào giấy" class="banner_fix">
    <img src="/images/banner-fixed.jpg" style="position: fixed;top: 120;left: 0px;" alt="Thẻ cào giấy" class="banner_fix">
        ...
        <div class="section-title bg-lable1">
          ...
          <div class="form-content bg1">
           <form name="buycard" action="#" method="post">
            ...
            <div class="form-group">
             <input type="text" maxlength="40" id="ctrlsoluongthe" name="soluongthe" value="" class="form-control" placeholder="Số lượng thẻ cần mua" title="Số lượng thẻ" /> </div>
             <div class="form-group">
              ...
              <div class="form-group">
                <div class="boxdrpmega">
                  <input class="txt nochange blur form-control" placeholder="Phương thức thanh toán" size="22" maxlength="40"
                       id="buyCardPaymentMethod" value="banthe247" name="buyCardPaymentMethod" type="text" title="" autocomplete="off">
                <span class="dropDownListArrow down"></span>
                <div style="display: none; text-transform: none !important" class="dropDownList">
                    <table>
                        <tbody>
                            ...
                            <tr align="left">
                                <td colspan="4" style="vertical-align:middle;height:40px;" class="last">
                                    <ul>
                                        <li>
                                            <input txt="banthe247" rel="buyCardPaymentMethod" value="banthe247" id="buyCardPaymentMethodSelect_member" name="buyCardPaymentMethod" type="radio" autocomplete="off">
                                            <label for="buyCardPaymentMethodSelect_member"><img src="/images/paycardvi.png" title="mua the dien thoai" alt="mua the dien thoai"></label>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                  ...
                  <div class="form-group divbt">
                    <button type="button" class="btn btn-spec1 btn-md btn-block" id="ctrlmuathebtn">Mua thẻ ngay</button>  </div>
                  </form>
                </div>
                   ...
                   <div class="panel panel-primary">
                     ...
                     <div class="row" id="Confirm_BuyCardDetail">
                      <div class="form-group col-sm-12">
                          <label class="col-sm-offset-1 col-sm-11" style="margin-top: 12px;">
                            <div style="font-weight: bold;color: #337ab7;">Vui lòng nhập thông tin tài khoản của bạn <br/> Nếu chưa có tài khoản quý khách vui lòng đăng ký tại banthe247.com</div>
                          </label>
                      </div>
                        <div class="col-sm-12">
                        ...
                        <div style="display: none;"><input type="email" value="" name="hide_email"><input type="password" name="hide_password" value=""></div>
                      <div class="form-group col-sm-12">
                       <label class="control-label col-sm-4" for="ctrlemailtxt_log">Địa chỉ Email:<span class="asterisk_input"></span></label>
                       <div class="col-sm-7">
                         <input type="email" id="ctrlemailmuathetxt_log" name="ctrlemailtxt_log" class="form-control" placeholder="Địa chỉ Email" value="" readonly onfocus="this.removeAttribute('readonly');"> </div>
                       </div>
                       <div class="form-group col-sm-12">
                         <label class="control-label col-sm-4" for="ctrlpasstxt_log">Mật khẩu:<span class="asterisk_input"></span></label>
                         <div class="col-sm-7">
                           <input type="password" id="ctrlpassmuathetxt_log" name="ctrlpasstxt_log" class="form-control" placeholder="Mật khẩu" value="" readonly onfocus="this.removeAttribute('readonly');"> </div>
                         </div>
                         <div class="form-group col-sm-12">
            ...
            <form class="form-horizontal" role="form">
                <div class="panel-body">
                    ...
                    <div class="modalbottom">
                        <button type="button" class="btn btn-primary" id="ctrcontinuemuathebtn" data-dismiss="modal" tabindex="1"><i class="fa fa-sign-in"></i> Thoát</button>
               ...
               <form name="buycard" action="#" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="boxdrpmega">
                <input class="txt nochange blur form-control" placeholder="Phương thức thanh toán" size="22" maxlength="40"
                       id="topupPaymentMethod" value="banthe247" name="topupPaymentMethod" type="text" title="" autocomplete="off">
                <span class="dropDownListArrow down"></span>
                <div style="display: none; text-transform: none !important" class="dropDownList">
                    <table>
                        <tbody>
                            ...
                            <tr align="left">
                                <td colspan="4" style="vertical-align:middle;height:40px;" class="last">
                                    <ul>
                                        <li>
                                            <input txt="banthe247" rel="topupPaymentMethod" value="banthe247" id="topupPaymentMethodSelect_member" name="topupPaymentMethod" type="radio">
                      ...
                      <div class="form-group divbt">
                        <button type="button" class="btn btn-md btn-block bg-lable3" style="color:#fff;" id="ctrltopupmobilebtn">Nạp tiền ngay</button></div>
                      </form>
                    </div>
                    <!--popup work start here-->
...
<div class="modal fade" id="naptiendienthoairesultmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="panel panel-primary">
            ...
            <form class="form-horizontal" role="form">
                <div class="panel-body">
                    ...
                    <div class="modalbottom">
                        <button type="button" class="btn btn-primary" id="ctrcontinuetopupbtn" data-dismiss="modal" tabindex="1"><i class="fa fa-sign-in"></i> Thoát</button>
                        <a href="/thong-bao-mua-tcoin" rel="nofollow" type="button" class="btn btn-success charge_money"><i class="fa fa-money"></i> Nạp tiền vào tài khoản</a>
                    </div>
                </div>
            </form>
                 ...
                 <div class="col-md-4 col-sm-12">
                  <div class="section-title bg-lable4">
                    <h2 style="font-size:18px;margin:0px;line-height:37px;">Mua thẻ game, virus, 3G/4G mobi</h2> </div>
                    <!--right section work start-->
                    <div class="form-content bg1" style="">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                         <div class="boxdrpmega">
                            <input class="txt nochange blur form-control" placeholder="Phương thức thanh toán" size="22" maxlength="40"
                                   id="buyCardGamePaymentMethod" value="banthe247" name="buyCardGamePaymentMethod" type="text" title="" autocomplete="off">
                            <span class="dropDownListArrow down"></span>
                            <div style="display: none; text-transform: none !important" class="dropDownList">
                                <table>
                                    <tbody>
                                        <tr align="left">
                                            <td colspan="4" class="last">
                                                <h4 class="fz14 fb700 cl333" style="text-transform: none;font-size: 14px">
                                                    Thanh toán bằng tài khoản thành viên
                                                </h4>
                                                <span class="separator"></span>
                                            </td>
                                        ...
                                        <tr align="left">
                                            <td colspan="4" style="vertical-align:middle;height:40px;" class="last">
                                                <ul>
                                                    <li>
                                                        <input txt="banthe247" rel="buyCardGamePaymentMethod" value="banthe247" id="buyCardGamePaymentMethodSelect_member" name="buyCardGamePaymentMethod" type="radio">
                                                        <label for="buyCardGamePaymentMethodSelect_member"><img src="/images/paycardvi.png" title="banthe247" alt="banthe247"></label>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                           ...
                           <form class="form-horizontal" role="form">
                             <div class="panel-body">
                               <div class="">
                                 ...
                                 <div class="modalbottom">
                                  <button type="button" class="btn btn-primary" id="ctrcontinuegamebtn" data-dismiss="modal" tabindex="1"><i class="fa fa-sign-in"></i> Thoát</button>
                                  <a href="/thong-bao-mua-tcoin" rel="nofollow" type="button" class="btn btn-success charge_money"><i class="fa fa-money"></i> Nạp tiền vào tài khoản</a>
                                </div>
                              </div>
                            </form>
  ...
  <div class="content-mobile">
    <ul class="ul_service">
      <li class="sv_2"><a href="/the-dien-thoai">Mua thẻ điện thoại </a></li>
      <li class="sv_1"><a href="/nap-tien-dien-thoai">Nạp tiền điện thoại</a></li>
      <li class="sv_4"><a href="/mua-the-game">MUA THẺ GAME</a></li>
    </ul>
  </div>
  <div class="container" style="float: left;width:100%;text-align:left;font-weight: bold;margin-bottom: 13px;margin-top:5px;padding: 0px;">
...
<div class="content-mobile">
  ...
  <? if($ismobile == 1){ ?>
    <?
$db_qr = new db_query("SELECT * FROM `newstable` WHERE Type = '101' AND IsActive='1'");
