   ...
   <div class="news-content">
      <div class="article">
         ...
         <span class="date_cate" style="display:block;text-align:right;margin-bottom:5px;"> <img src="/images/icon_clock.png" alt="Clock"> Cập nhật: <?= date("d/m/Y h:i:s A",strtotime($row1['PublicDate'])) ?></span> 
         <div class="new_description">
            
               <p><?= trim(removeHTML($row1['Intro'])) ?></p>
               <?= $row1['Description'] ?>
