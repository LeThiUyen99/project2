  <header>
    <div class="welcome">
      <div class="container">
        <div class="row">
          <div class="col-md-5 col-xs-12 text-wc">
            <p>BANTHE247.COM xin kính chào quý khách!</p>
          </div>
          <div class="col-md-7 col-xs-12 box-dn">
              <div class="boxlogin col-md-4  pull-right">
              <?php if($ismobile == 1){ ?>
                <small class="head-sum"> Hotline: 0972.022.116 - <a href="skype:live:binhminhmta123?chat"> <img class=" lazyloaded" data-src="/images/skype.png" alt="chat skype" src="/images/skype.png" height="21px">banthe247.com</a></small>
                <? } ?>
                 <ul id="mini-nav">
                 <? if($logger == 1){
                 ...
                 <li class="list-box dropdown" id="litaikhoan">  
                    <a rel="nofollow" id="drop7" href="#" role="button" class="btnc dropdown-toggle white" data-toggle="dropdown"> 
                        <i class="fa fa-user"></i> <b><?= $lg_userinfo['FullName'] ?></b> </a>  
                        <ul class="dropdown-menu server-activity">
                        <li style="text-align:center;"><span style="color:#337ab7;font-size:12px;">(Tài khoản: </span> 
                        <span style="color:#337ab7;font-size:12px;"><b> <?= number_format($khaDung) ?></b> )</span> </li>
                          <li><a rel="nofollow" href="/user/lichsumuathe"><i class="fa fa-user"></i>Lịch sử giao dịch</a></li> <li> <a rel="nofollow" href="/user/index" title="Thay đổi mật khẩu"><i class="fa fa-user"></i>Thay đổi mật khẩu</a> </li> <li> <a rel="nofollow" href="#logout" id="logoutbtn" title="Đăng xuất"><i class="fa fa-sign-out"></i> Đăng xuất</a> </li> </ul> 
                 </li> 
                <? }else{ ?>
   ...
   <div class="container">
     <div class="navbar"> 
     <?php if($ismobile != 1){ ?>
       <div class="boxlogin col-md-3  pull-right nonemobile">
        <div class="contact-menu">
          <div class="contact-list">
            <img src="../images/phone.jpg" alt="hotline">
            <span style="font-weight: bold;color: #0f70b8;font-size: 15px;">0972.022.116</span>
          </div>
          <div class="contact-list"><a href="skype:live:binhminhmta123?chat" rel="nofollow">
            <img src="../images/skype.png" alt="chat skype">
            <span style="font-weight: bold;color: #0f70b8;font-size: 15px;">banthe247.com</span></a>
          </div>
          <div class="contact-list">
            <img src="../images/email.jpg" alt="email">
            <span style="font-weight: bold;color: #0f70b8;font-size: 15px;">hotrobanthe247.com@gmail.com</span>
          </div>
          <div class="contact-list"><a href="http://zalo.me/0982079209" rel="nofollow" target="_blank" title="Click chọn để chat qua zalo">
            <img src="../images/icon_zalo.png" alt="zalo">
            <span style="font-weight: bold;color: #0f70b8;font-size: 15px;">banthe247.com</span>
            </a>
          </div>
        </div>
      ...
      <div class="logo col-md-2">
       <a href="/" class="navbar-brand" rel="nofollow" title="Website Mua thẻ điện thoại và nạp tiền điện thoại">
        <img src="/images/logo.png" alt="bán thẻ cào" title="logo Banthe247.com" />
      </a></div>
      <?php if($ismobile != 1){ ?>
      <div class="col-md-7 col-xs-12 menu-center ">
        <!--<ul>
          <li><a href="/">Cách nạp tiền viettel online chiết khấu cao</a></li>
          <li><a href="/">Hướng dẫn nạp tiền mobifone online nhận chiết khấu cao nhất</a></li>
          <li><a href="/">Nạp tiền Vinaphone chiết khấu cao nhanh chóng</a></li>
        </ul>-->
      </div>
      <? } ?>
    </div>
  ...
  <div class="container">
    <div class="navbar">
        <div class="col-md-12 col-xs-12 menu-mobi">
          ...
          <div class="navbar-header"> 
            ...
            <div class="navbar-collapse collapse" id="navbar-main">
              <ul class="nav navbar-nav">
                <li class=""><a rel="nofollow" href="/" title="Trang chủ">Trang chủ</a></li>
                <li class="mtdt"><a  href="/the-dien-thoai" title="mua thẻ điện thoại">Mua thẻ điện thoại</a></li>
                <li class="mtg"><a rel="nofollow" href="/mua-the-game" title="mua thẻ game">Mua thẻ game</a></li>
                <li class="ntdt"><a rel="nofollow" href="/nap-tien-dien-thoai" title="nạp tiền điện thoại">Nạp tiền điện thoại</a></li>
                
              
              <li class="nt"><a rel="nofollow" href="/thong-bao-mua-tcoin" title="Nạp tiền vào tài khoản">Nạp tiền vào tài khoản</a></li>
              <li class="ct"><a rel="nofollow" href="/chiet-khau" title="chiết khấu">Chiết khấu</a></li>
               <li class="ct"><a rel="nofollow" href="/chuyen-muc-hoi-dap" title="hỏi đáp">Hỏi đáp</a></li>
               <li class="dropdown"> <a rel="nofollow" class="dropdown-toggle" title="Tin tức" data-toggle="dropdown">Tin tức</a>
                 <ul class="dropdown-menu theme_nav_dropdown">
                  <li><a rel="nofollow" href="/tin-tuc-1.html" title="Tin tức">Tin tức bán thẻ</a></li>
                  <li><a rel="nofollow" href="/huong-dan-su-dung-5.html" title="Hướng dẫn">Hướng dẫn</a></li>
                 
                  <li><a rel="nofollow" href="/doi-the" title="Đổi thẻ"><strong>Đổi thẻ</strong></a></li>
                </ul>
              </li>
              <li class="dropdown"> <a rel="nofollow" class="dropdown-toggle" title="Shop" data-toggle="dropdown">Shop</a>
               ...
               <? if($logger == 1){ ?> 
               <li class="ct"><a rel="nofollow" href="/user/lichsumuathe" title="Lịch sử giao dịch">Lịch sử giao dịch</a></li>
               <? }?>
            </ul>
          </div>
        </div>
