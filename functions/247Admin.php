 ...
 * @copyright 2018
 */
 require_once '247.php';
 require_once '247User.php';
...
{
    $kq=array("success"=>false,"msg"=>"");
    if(intval($idKhachHang) > 0 && intval($soTien) > 0 ){
...
function AdminApprovalMoneyToCustommer($findKey,$tuNgay,$denNgay,$trangThai,$nganHang,$iDisplayStart,$iDisplayLength)
{
    ...
    return array("kq"=>$kq,"total"=>$total,"tongTien"=>$tongtien,"daDuyet"=>$daduyet,"chuaDuyet"=>$chuaduyet,"daHuy"=>$dahuy) ;
}
